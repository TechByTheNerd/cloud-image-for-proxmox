...
# =======================================================================================================
# TEMPLATE ONLY - Copy this file to ./rebuild-rockylinux-templates.sh and configure that file for your needs.
# =======================================================================================================
...
./prox-cloud-template-add-rockylinux.sh ${HOST_DIGIT}28000 SSD-0${HOST_DIGIT}A 8 $ACCOUNT_NAME $PASSWORD $DOMAIN $SSH_KEY_ID

echo "[*] Rebuilding 'AlmaLinux 9'..."
./prox-cloud-template-add-rockylinux.sh ${HOST_DIGIT}29000 SSD-0${HOST_DIGIT}A 9 $ACCOUNT_NAME $PASSWORD $DOMAIN $SSH_KEY_ID
...
# keep them at the end of the list of VM's. The "28000" and "29000" is metadata for the
# version of that distribution (e.g. "18000" is Rocky Linux 8 with no minor version
